...
static NSString *ksaloonLat = @"saloonLat";
static NSString *ksaloonLong = @"saloonLong";
...
- (void) encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeObject:self.saloonLat forKey:ksaloonLat];
    [encoder encodeObject:self.saloonLong forKey:ksaloonLong];
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    self.saloonLat = [decoder decodeObjectForKey:ksaloonLat];
    self.saloonLong = [decoder decodeObjectForKey:ksaloonLong];
